...
public class ShirtCreatorCodeBehind {
	...
	@FXML
	private Button deleteShirtButton;
	@FXML
	...
	void onRequestButtonClick(ActionEvent event) {
		...
		if (result.isPresent() && result.get() == ButtonType.OK) {
			addRequest(new TShirt(random.nextInt(), shirtAttributes.getSize(), shirtAttributes.getMaterial(),
					shirtAttributes.getColor(), shirtAttributes.getSleeveLength(), shirtAttributes.getShoulderWidth(),
